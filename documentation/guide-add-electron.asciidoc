...
This file needs to be modified to create references to `./src/tsconfig.app.json` and `./src/tsconfig.spec.json`:
...
This will be extended on both app and spec versions and it is the base.
...
----
  "scripts": {
    ...
    "lint": "ng lint",
    "e2e": "ng e2e",
    "electron:serve": "ng build --base-href ./ && npx electron . --serve",
