...
Check out the https://github.com/devonfw/devon4ng/tree/develop/samples/AngularMockService[Angular Mock Service] sample from the samples folder and easily get started with front end development using dummy data.
