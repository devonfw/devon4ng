...
* Add _@import '~@angular/material/theming';_ at the beginning of the every stylesheet to be able to use angular material prebuilt color palettes and functions.
