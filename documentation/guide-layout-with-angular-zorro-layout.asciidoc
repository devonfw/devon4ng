...
The purpose of this guide is to get a basic understanding of creating layouts using https://ng.ant.design/docs/introduce/en[Angular Zorro] in a devon4ng application.
...
We have all the Angular Zorro related dependencies set up in our project, we can start coding.
...
Next step is to create a component for the header. We will create it with the command
...
To do it, firstable, we need to import the menu module on app.module.
